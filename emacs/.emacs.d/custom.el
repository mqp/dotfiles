(custom-set-variables
 ...
 '(package-selected-packages
   '(magit quelpa tree-sitter minimap ligature mood-line moody cyberpunk-theme material-theme material gruvbox-theme
           consult marginalia vertico apheleia treemacs neotree so-long yaml-mode web-mode vterm typescript-mode tsi
           tree-sitter-langs systemd sudo-edit ssh-config-mode rustic quelpa-use-package prettier popup php-mode
           nginx-mode lua-mode lsp-mode json-mode ido-completing-read+ handlebars-mode glsl-mode forge flycheck eglot
           dockerfile-mode diminish csharp-mode company benchmark-init amx))
 '(safe-local-variable-directories '("/home/mqp/src/notadoctor/"))
 '(safe-local-variable-values
   '((eval when (fboundp 'rainbow-mode) (rainbow-mode 1))
     (lsp-file-watch-ignored-directories-additional "/common/lib$" "/docs/build$" "/functions/lib$" "/functions/dist$"
                                                    "/functions/firestore_export$")
