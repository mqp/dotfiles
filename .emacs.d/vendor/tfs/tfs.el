...
(defvar tfs/tf-exe  "c:\\Program Files (x86)\\Microsoft Visual Studio 10.0\\common7\\ide\\tf.exe"
  "location of the tf.exe command.")

(defvar tfs/tfpt-exe  "c:\\Program Files (x86)\\Microsoft Team Foundation Server 2010 Power Tools\\TFPT.exe"
  "location of the tfpt.exe command.")
